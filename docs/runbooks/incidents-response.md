...
- Is it networking/DNS/certs? (timeouts, TLS errors)
- Is it Kubernetes health? (pods flapping, HPA, readiness)
...
- Document final status + customer impact summary

## Post-incident
- Postmortem within 24–72 hours
- Action items: owners + deadlines + verification plan
